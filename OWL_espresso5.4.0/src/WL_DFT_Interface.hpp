...
extern "C" {
  ...
  void wl_qe_startup(int* lib_comm, int* nim, int* npl, int* nta, int* nbn, int* ndg, const char* infile);
  void run_pwscf_(int *exit_status);
  void wl_qe_stop(int *exit_status);
  ...
  void wl_do_pwscf(int *exit_status);
  void wl_stop_run(int *exit_status);
